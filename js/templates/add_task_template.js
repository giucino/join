    ...
    return /* html */ `
        <div class="float-add-task-container">
            ...
            <div class="add-task-container-first">
                <div class="add-task-container-titel">
                    <div class="add-task-titel-textcontainer">
                        <input id="addTaskTitle" class="add-task-titel-textfield" placeholder="Enter a title"></input>
                    </div>
            ...
            <div class="add-task-container-priority">
                ...
                <div class="priority-choice">
                    ...
                    <button type="button" onclick="addPriority(this)" id="addPrioLow" class="priority-choice-inner prio-low">
                        Low
                        <div class="priority-choice-inner-pic">
            ...
            <div class="subtasks-container">
                ...
                <div class="add-subtask-input">
                    <input onclick="addOpenSubtaskInput()" type="text" id="addSubtaskInput" class="new-subtask-textfield" placeholder="Add new subtask">
                    <img onclick="addOpenSubtaskInput()" class="open-subtask-button" src="./img/open_subtask.png">
                    <img onclick="addCloseSubtaskInput()" class="add-subtask-button hidden" id="addCloseSubtask" src="./img/close_subtask.png"> 
                    <span class="separator" id="addSeparator">|</span> 
                    <img onclick="addAddSubtask()" class="add-subtask-button hidden" id="addAddNewSubtask" src="./img/add_subtask.png">
                </div>
        ...
        <!-- <div class="add-task-buttons">
            <div class="add-task-buttons-inner">
                <button onclick="addResetTaskForm()" type="button" id="clearTaskButton" class="button-clear">
                    Clear
