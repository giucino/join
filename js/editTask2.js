...
function addEditingClasses(container) {
    ...
    let cancelButton = container.querySelector(".edit-edit-delete-subtask-button");
...
//     removeClassAndStyle(container.querySelector(".edit-edit-delete-subtask-button"), "", "display", "none");
