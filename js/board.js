...
// function generateAssignedToHTML(assignedTo, bgcolors) {
//     let assignedToHTML = '';
//     let leftPosition = -7;

//     const filteredAssignedTo = assignedTo.filter(name => name !== null);
...
// function generateProgressBarHTML(elementId, completedTasksCount, allTasksCount) {
//     const progress = (completedTasksCount / allTasksCount) * 100;

//     return /*html*/`
//         <div class="progress-bar" id="progress-bar${elementId}" style="width: ${progress}%;"></div>
//     `;
// }

// function generateTasksHTML(element) {
//     const priorityImageSrc = setPriorityImage(element.priority);
//     const assignedToHTML = generateAssignedToHTML(element.assignedTo, element.bgcolor || []);
//     const { subtasksHTML, completedTasksCount } = generateSubtasksHTML(element.subtasks);
//     const allTasksCount = element.subtasks.length;
//     const progressBarHTML = generateProgressBarHTML(element.id, completedTasksCount, allTasksCount);
...
//                     ${progressBarHTML}
//                 </div>
//                 <div class="subtasks">${completedTasksCount} / ${allTasksCount} Subtasks</div>
//             </div>
//             <div class="prio-container">
//                 <div id="assigned-to" class="user-container-board">
//                     ${assignedToHTML}
